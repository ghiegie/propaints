...
?>
        ...
        <section id="special-price">
            <div class="container">
                ...
                <div id="filers" class="button-group text-right font-baloo font-size-16">
                        ...
                        <div class="item py-2" style="width: 200px;">
                            <div class="product font-rale">
                                <a href="<?php printf("%s?item_id=%s", "product.php", $item['item_id']); ?>">
                                    <img src="<?php echo $item['item_image'] ?? "assets/products/13.png"; ?>" alt="prodcut1" class="img-fluid">
                                </a>
