                        ...
                        <div class="row border-top py-3 mt-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="qty d-flex pt-2">
                                    <d-flex class="font-rale w-25">
                                        <button class="qty-up border bg-light" data-id="<?php echo $item['item_id'] ?? '0' ?>"><i class="fas fa-angle-up"></i></button>
                                        <input  data-id="<?php echo $item['item_id'] ?? '0' ?>" type="text" class="qty_input border px-2 w-50 bg-light" disabled value="1" placeholder="1">
                                        <button data-id="<?php echo $item['item_id'] ?? '0' ?>" class="qty-down border bg-light"><i class="fas fa-angle-down"></i></button>
                                    </d-flex>
                                    <form method="post">
                                        <input type="hidden" value="<?php echo $item['item_id'] ?? 0 ?>" name="item_id">
                                        <button type="submit" class="btn font-baloo text-danger px-3 border-right" name="delete-cart-submit">Delete</button>
                                    </form>
                                    <form method="post">
                                        <input type="hidden" value="<?php echo $item['item_id'] ?? 0 ?>" name="item_id">
                                        <button type="submit" name="wishlist-submit" class="btn font-baloo text-danger">Save Later</button>
                                    </form>
